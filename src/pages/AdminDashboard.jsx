...
import { UserCircle } from 'lucide-react'; // Import ikon User
  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-6 relative">
      ...
      <div className="absolute top-6 right-6 z-50">
        <Link to="/login" className="flex items-center gap-2 bg-white/60 hover:bg-white/90 backdrop-blur-md px-4 py-2 rounded-full shadow-sm text-brand-dark font-bold transition-all border border-white">
          <UserCircle size={20} />
          {/* <span></span> */}
        </Link>
      </div>
      ...
      <div className="glass-panel p-10 rounded-3xl w-full max-w-lg text-center relative overflow-hidden">
        {/* ... (Isi efek blur dan judul tetap sama seperti sebelumnya) ... */}
